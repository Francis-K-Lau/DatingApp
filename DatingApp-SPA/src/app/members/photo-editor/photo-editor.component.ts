...
export class PhotoEditorComponent implements OnInit {
  ...
  initializeUploader() {
    ...
    /*
      Fix this following credentails problem in uploading response
      ============================================================
        Access to XMLHttpRequest at 'http://localhost:5000/api/users/1,lola/photos' from origin 'http://localhost:4200' 
